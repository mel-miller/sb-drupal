...
**NOTE: These instructions are still a work in progress and need to be fully tested. A different approach may be needed in the future.**
**NOTE 2: The NPM package is not yet published.**
