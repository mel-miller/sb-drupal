...
CTA uses the anchor `<a>` element to allow the user to navigate to another location, initiate an email, or initiate a phone call. This particular component is a standalone link that can be used as a CTA within your layout or as part of another component.
